...
class Gr00tPolicy(BasePolicy):
    ...
    def _load_model(self, model_path):
        ...
        # state_dict_1 = load_file("/mnt/data/sftp/data/vla_intern/workspace/binh/2026/prunner/Gr00tN1.5_prunner/outputs/2026-03-14/16-59-41_bz24_maxstep60000_LIBERO_gr00tn15_base/bz24_maxstep60000_LIBERO_gr00tn15_base/checkpoint-60000/model-00001-of-00002.safetensors")
        # state_dict_2 = load_file("/mnt/data/sftp/data/vla_intern/workspace/binh/2026/prunner/Gr00tN1.5_prunner/outputs/2026-03-14/16-59-41_bz24_maxstep60000_LIBERO_gr00tn15_base/bz24_maxstep60000_LIBERO_gr00tn15_base/checkpoint-60000/model-00002-of-00002.safetensors")
        
        # all_state_dict_keys = list(state_dict_1) + list(state_dict_2) 
        # for name, p in model.named_parameters():
        #     # if not (name in state_dict_1.keys() or name in state_dict_2.keys()):
        #     if name not in all_state_dict_keys:
        #         print(f"{name=}")
