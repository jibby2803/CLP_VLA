...
DATA_PATH="/mnt/data/sftp/data/vla_intern/workspace/hf_home/lerobot/binhng/groceries2basket" # banana drawer
...
EXP_NAME="bz${BATCH_SIZE}_maxstep${MAX_STEPS}_akhoa_GROCERIES_gr00tn15_CKA_v1"
