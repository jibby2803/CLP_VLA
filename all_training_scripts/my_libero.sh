#!/bin/bash
#SBATCH --job-name=naivegr15libero
...
# EXP_NAME="bz${BATCH_SIZE}_maxstep${MAX_STEPS}_LIBERO_gr00tn15_COSINE_v1"

EXP_NAME="bz${BATCH_SIZE}_maxstep${MAX_STEPS}_LIBERO_gr00tn15_MSE_v1"
