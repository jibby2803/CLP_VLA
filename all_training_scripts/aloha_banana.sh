...
DATA_PATH="/mnt/data/sftp/data/vla_intern/workspace/binh/2026/prunner/data/ALOHA_RIGHTARM/banana" # banana drawer
...
EXP_NAME="bz${BATCH_SIZE}_maxstep${MAX_STEPS}_ALOHA_banana_gr00tn15_CKA_v1"
...
cp examples/corl_aloha_right_arm/modality.json ${DATA_PATH}/meta/modality.json
CUDA_VISIBLE_DEVICES=0 python scripts/gr00t_finetune.py \
    --base-model-path ${MODEL_DIR} \
    --dataset-path ${DATA_PATH} \
    --data_config examples.corl_aloha_right_arm.data_config:AlohaRightArmConfig \
