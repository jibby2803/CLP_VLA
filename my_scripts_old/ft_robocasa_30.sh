...
# EXP_NAME="debug"
EXP_NAME="base_robocasa_30demos_v2_bz32_lr1e-4_24tasks"

DATA_PATH="/mnt/data/sftp/data/vla_intern/workspace/data/ROBOCASA/robocasa_merged_24_tasks_30demos_v3"
