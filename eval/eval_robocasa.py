...
# sys.path.insert(0, "/mnt/data/sftp/data/vla_intern/workspace/binh/gr00t_custom")
...
class Args:
    ...
    replan_steps: int = 10
    model_dir: str="/mnt/data/sftp/data/vla_intern/workspace/binh/gr00t_custom/outputs/2026-01-10/base_robocasa_100demos_v2_bz32_lr1e-4_24tasks_v1/checkpoint-60000"
...
python eval_robocasa.py \
   --args.exp-name gr00t_base_robocasa_100demos_60k_24tasks \
   --args.num-trials 25 \
  --args.seed 0 \
   --args.gpu 0
