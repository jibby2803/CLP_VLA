...
--model-path /mnt/data/sftp/data/vla_intern/workspace/binh/2026/prunner/Gr00tN1.5_prunner/outputs/2026-05-07/18-00-38_bz32_maxstep15000_ALOHA_flytowel_gr00tn15_CKA_v1/checkpoint-15000 \
--data_config "aloha_2arms" \
--dataset_path /mnt/data/sftp/data/vla_intern/workspace/binh/2026/prunner/data/ALOHA_BIMANUAL/fly_towel \
--save_plot_path ./test  \
...
class ArgsConfig:
    ...
    video_backend: Literal["decord", "torchvision_av"] = "torchvision_av" #"decord"
