...
DATA_PATH="/mnt/data/sftp/data/vla_intern/workspace/hf_home/lerobot/binhng/close_pot" # banana drawer
...
EXP_NAME="bz${BATCH_SIZE}_maxstep${MAX_STEPS}_akhoa_CLOSEPOT_gr00tn15_CKA_v1"
