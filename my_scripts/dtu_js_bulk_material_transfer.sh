...
DATA_PATH="/mnt/data/sftp/data/vla_intern/workspace/binh/2026/prunner/data/DTU/js/bulk_material_transfer" #  lab_tubes
...
EXP_NAME="bz${BATCH_SIZE}_maxstep${MAX_STEPS}_DTU_bulk_material_transfer_gr00tn15_CKA_prun_v1"
...
cp examples/DTU_js/modality.json ${DATA_PATH}/meta/modality.json
CUDA_VISIBLE_DEVICES=0 python scripts/gr00t_finetune.py \
    --base-model-path ${MODEL_DIR} \
    --dataset-path ${DATA_PATH} \
    --data_config examples.DTU_js.data_config:UR5_DTU_joint_state \
