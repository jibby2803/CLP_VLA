...
DATA_PATH="/mnt/data/sftp/data/vla_intern/workspace/binh/2026/prunner/data/ALOHA_BIMANUAL/fly_towel"
...
EXP_NAME="bz${BATCH_SIZE}_maxstep${MAX_STEPS}_ALOHA_flytowel_gr00tn15_CKA_v1_13k"
