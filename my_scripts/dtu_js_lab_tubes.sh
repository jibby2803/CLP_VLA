...
DATA_PATH="/mnt/data/sftp/data/vla_intern/workspace/binh/2026/prunner/data/DTU/js/lab_tubes"
...
EXP_NAME="bz${BATCH_SIZE}_maxstep${MAX_STEPS}_DTU_lab_tubes_gr00tn15_CKA_prun_v1"
