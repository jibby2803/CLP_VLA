...
DATA_PATH="/mnt/data/sftp/data/vla_intern/workspace/binh/2026/prunner/data/ALOHA_RIGHTARM/house" # banana drawer
...
EXP_NAME="bz${BATCH_SIZE}_maxstep${MAX_STEPS}_ALOHA_house_gr00tn15_CKA_v1"
