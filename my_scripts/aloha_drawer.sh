...
DATA_PATH="/mnt/data/sftp/data/vla_intern/workspace/binh/2026/prunner/data/ALOHA_RIGHTARM/drawer" # banana drawer
...
EXP_NAME="bz${BATCH_SIZE}_maxstep${MAX_STEPS}_ALOHA_drawer_gr00tn15_CKA_v1"
